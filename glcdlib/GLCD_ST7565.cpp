...
#define LCDUNUSEDSTARTBYTES 4 //def 4
...
//if (PIN_CS > 0)
 //   digitalWrite(PIN_CS, LOW);
    ...
    st7565_Command(CMD_SET_COM_NORMAL); // added CMD_SET_COM_REVERSE   - CMD_SET_COM_NORMAL
...
void GLCD_ST7565::begin(byte contrast) {
    ...
    st7565_Command(CMD_SET_ALLPTS_NORMAL);
        //st7565_Command(CMD_SET_ADC_REVERSE);   //added for reverse
    //st7565_Command(CMD_SET_COM_REVERSE);       //added for reverce
